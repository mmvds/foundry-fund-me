...
DEFAULT_ANVIL_KEY := 0xa8f0a8c85a922bfcf755b701a7068369b9af90540eb633e0849ef18ebb096d22
...
ifeq ($(findstring --network mumbai,$(ARGS)),--network mumbai)
	NETWORK_ARGS := --rpc-url $(MUMBAI_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(POLYGON_API_KEY) -vvvv
endif
